      ...
      <div className="container mx-auto py-12 px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link href="/" className="flex items-center gap-2">
              <BookOpen className="h-6 w-auto text-primary" />
              <span className="text-lg font-semibold text-foreground">LMSystem</span>
            </Link>
            <p className="mt-2 text-sm text-muted-foreground">
              A modern and intuitive learning management system designed for educators and students.
            </p>
          </div>
          <div>
        ...
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} LMSystem. All rights reserved.
          </p>
